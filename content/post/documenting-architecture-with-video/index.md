...
*Related posts: [The Island of Misfit Toys](/post/making-the-azure-private-link-video/) on how this video workflow got built, and [Streamlining Blog Writing with Claude Code](/post/streamlining-blog-writing-with-claude-code/) on the pipeline that produced this article. The full written architecture doc with C4, generated from the research agent based on the harvester codebase [is here if you are curious](https://github.com/aheld/aaronheld-blog/blob/2a996ae00b1d6faae9acf5770c30df76f766eef0/content-workspace/01_research/documenting-architecture-with-video/harvestor-architecture.md).*
